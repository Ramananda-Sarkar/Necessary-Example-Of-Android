package com.ramananda.textdrawer;
...
import com.rama.dataprovider.ColorGenerator;
import com.rama.dataprovider.DrawableProvider;
import com.rama.dataprovider.TextDrawable;
...
public class ListDataActivity extends Activity {
	 ...
	 private static final int HIGHLIGHT_COLOR = 0x999be6ff;
	    ...
	    private List<ListData> mDataList = Arrays.asList(
	            ...
	            new ListData("Pears"),
	            new ListData("Kiwi"),
	            new ListData("Ramananda"),
	            new ListData("Ashu"),
	            new ListData("Parimal")
	    );
	    ...
	    private class SampleAdapter extends BaseAdapter {
	        ...
	        public View getView(final int position, View convertView, ViewGroup parent) {
	            ...
	            if (convertView == null) {
	                convertView = View.inflate(ListDataActivity.this, R.layout.list_items_layout, null);
